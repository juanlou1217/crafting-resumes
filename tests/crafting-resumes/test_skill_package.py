...
SKILL_ROOT = ROOT / "skills/crafting-resumes"
...
ANONYMOUS_FIXTURE_PATHS = (
    ...
    ROOT / "tests/crafting-resumes/behavior/candidate",
    ROOT / "tests/crafting-resumes/behavior/regressions",
    ROOT / "tests/crafting-resumes/pdf/fixtures",
    ROOT / "tests/crafting-resumes/manifests/baseline",
    ROOT / "tests/crafting-resumes/manifests/candidate",
)
ANONYMOUS_FIXTURE_FILES = (
    ROOT / "tests/crafting-resumes/behavior/baseline-summary.md",
    ROOT / "tests/crafting-resumes/behavior/rubric.md",
)
